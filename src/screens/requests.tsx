        ...
        <View style={styles.container}>
            ...
            <View style={styles.localContainer}>
                ...
                <View style={styles.inputAmount}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', textAlign: 'center' }}>{reqError}</Text>
                    ...
                    {!repeatVisible ? (
                        <View style={{width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'center'}}>
                            <TouchableOpacity
                                style={{...styles.repeatButton, alignSelf: 'flex-start', display: 'flex', flexDirection: 'row', justifyContent: 'center'}}
                                onPress={() => { setRepeatVisible(true) }}>
                                <Text style={{ color: "black", textAlign: 'center', fontFamily: 'WorkSans_600SemiBold' }}>Repeat</Text>
                                {repeat != 0 && (
                                    <Text style={{ color: "black", textAlign: 'center', fontFamily: 'WorkSans_600SemiBold' }}>: {
                                        repeat == 1 ? "Daily" : repeat == 2 ? "Weekly" : repeat == 3 ? "Monthly" : "Yearly"
                                    }</Text>
                                    )}
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row', width: '100%', justifyContent: 'space-between' }}>
                            <TouchableOpacity
                                onPress={() => { setRepeatVisible(false); setRepeat(0) }}
                                style={{ width: '18%%' }}>
                                <Text style={styles.repeatButton}>None</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={() => { setRepeatVisible(false); setRepeat(1) }}
                                style={{ width: '18%%' }}>
                                <Text style={styles.repeatButton}>Daily</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={() => { setRepeatVisible(false); setRepeat(2) }}
                                style={{ width: '18%%' }}>
                                <Text style={styles.repeatButton}>Weekly</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={() => { setRepeatVisible(false); setRepeat(3) }}
                                style={{ width: '22%%' }}>
                                <Text style={styles.repeatButton}>Monthly</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={() => { setRepeatVisible(false); setRepeat(4) }}
                                style={{ width: '18%' }}>
