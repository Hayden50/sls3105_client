...
export declare const CodeControl: React.ForwardRefExoticComponent<Pick<CodeControlProps, "length" | "values" | "isDisabled" | "isLoading" | "errorText" | "setValues" | "isSuccessfullyFilled"> & React.RefAttributes<{
    reset: any;
}>>;
export {};
