...
export declare const Box: React.ForwardRefExoticComponent<Pick<Partial<Record<"isDisabled" | "hasError" | "isLoading" | "isOpen" | "isActive", any>> & React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement> & {
    css?: import("../styledSystem/types").ThemableCssProp;
} & AsProp & {}, "key" | "isDisabled" | "hasError" | "isLoading" | "isOpen" | "isActive" | "as" | keyof React.HTMLAttributes<HTMLDivElement> | "css"> & React.RefAttributes<HTMLDivElement>>;
export {};
